...
- Name: D.2-settings-autodeal-on.spec.ts >> D.2 — Auto-Add Deal ON → inbound creates at least one new Deal
- Location: tests\e2e-playwright\specs\D.2-settings-autodeal-on.spec.ts:29:1
